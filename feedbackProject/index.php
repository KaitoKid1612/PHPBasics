                        ...
                        <form class="mx-1 mx-md-4" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>">
                            <div class="d-flex flex-row align-items-center mb-4">
                                ...
                                <div class="form-outline flex-fill mb-0">
                                    ...
                                    <label class="form-label" for="name" name="name">Your Name</label>
                                </div>
                            </div>
                            <div class="d-flex flex-row align-items-center mb-4">
                                ...
                                <div class="form-outline flex-fill mb-0">
                                    ...
                                    <label class="form-label" for="email" name="email">Your Email</label>
                                </div>
                            </div>
                            <div class="d-flex flex-row align-items-center mb-4">
                                <i class="fas fa-lock fa-lg me-3 fa-fw"></i>
                                <div class="form-outline flex-fill mb-0">
                                    <input type="textarea" id="body" class="form-control" />
                                    <label name="body" class="form-label" for="body">Body</label>
                                </div>
                            </div>
                            <!-- <div class="d-flex flex-row align-items-center mb-4">
